...
def parse_args():
    ...
    parser.add_argument(
        "--data_path", default="../", type=str, help="path to the decompressed dataset"
    )
    parser.add_argument(
        "--save_path",
...
if __name__ == "__main__":
    ...
    if args.task == "congestion":
        feature_list = [
            "routability_features_decompressed/macro_region",
            "routability_features_decompressed/RUDY/RUDY",
        ...
        feature_list = [
            "routability_features_decompressed/macro_region",
            "routability_features_decompressed/cell_density",
            "routability_features_decompressed/RUDY/RUDY_long",
            "routability_features_decompressed/RUDY/RUDY_short",
        ...
        feature_list = [
            "IR_drop_features_decompressed/power_i",
            "IR_drop_features_decompressed/power_s",
            "IR_drop_features_decompressed/power_sca",
            "IR_drop_features_decompressed/power_all",
            "IR_drop_features_decompressed/power_t",
        ]
        label_list = ["IR_drop_features_decompressed/IR_drop"]
    else:
        raise ValueError(
            "Please specify argument --task from congestion, DRC and IR_drop"
        )
